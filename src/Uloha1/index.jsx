...
const Uloha1 = () => {
	const [jeZapnuta, setJeZapnuta] = useState(true);
	...
	return (
		<div className="zarovka">
			...
			<div className="zarovka__tlacitka">
				<button onClick={zapnout} className="zarovka__tlacitko" disabled={jeZapnuta}>
					zapnout
				</button>
				<button onClick={vypnout} className="zarovka__tlacitko" disabled={!jeZapnuta}>
					vypnout
				</button>
			</div>
		</div>
